...
layout = [
    ...
    [sg.Text('Quantidade do Produto', size=(25, 1), font=("Any", 18)),
     sg.InputText("1", size=(8, 1), key='qtd', font=("Any", 15)),
    ...
    [sg.Text('Código do Produto', size=(25, 1), font=("Any", 18)),
     sg.InputText(background_color='White', size=(8, 1), key='lanche1', font=("Any", 15)),
